        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {packages.map((pkg, index) => (
            ...
            >
              ...
              <CardHeader className="relative text-center p-8 pb-6">
                <CardTitle className="text-2xl font-black text-gray-900 mb-4" style={{ fontFamily: 'Poppins, system-ui, sans-serif' }}>
                  {pkg.title}
                </CardTitle>
                <div className="mb-6">
                  <span className="text-5xl font-black bg-gradient-to-r from-accent to-orange-500 bg-clip-text text-transparent">
                    {pkg.price}
                  </span>
                  {pkg.priceUnit && (
                    <span className="text-gray-500 text-lg font-medium">{pkg.priceUnit}</span>
                  )}
                </div>
              </CardHeader>
